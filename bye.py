...
def process_user_input(input_str):
    try:
        if input_str.lower() == 'exit':  # Exit command
            ...
            expr = input_str[5:]
            return eval(expr)  # SECURITY RISK: Replace eval with a safer alternative
        ...
        return "Invalid input"  # Provide more descriptive error messages
...
if __name__ == "__main__":
    ...
    print(process_user_input("calc 5+3"))  # SECURITY RISK: eval usage
